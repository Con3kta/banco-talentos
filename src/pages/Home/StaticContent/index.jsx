                ...
                <article className='search-content' >
                    ...
                    <aside>
                        ...
                        <div className='language-icon-container'>
                            <span className='icon' id='HTML5' >
                                <TbBrandHtml5 />
                            </span>
                            <span className='icon' id='JavaScript' >
                                <TbBrandJavascript />
                            </span>
                            <span className='icon' id='CSS3' >
                                <TbBrandCss3 />
                            </span>
                            <span className='icon' id='MySQL' >
                                <SiMysql />
                            </span>
                            <span className='icon' id='React JS' >
                                <FaReact />
                            </span>
                            <span className='icon' id='Node JS' >
                                <FaNodeJs />
                            </span>
                        </div>
                    </aside>
